	...
	<body id="body" class="user-select-none">
		...
		<header>
			...
			<div class="left">
				...
				<div id="menu">
					...
					<ul>
						...
						<li data-url=<?php echo $child->dataUrl ?> data-preview=<?php echo $child->dataPreview ?> >
							<div class="name"><?php echo $child->name ?></div>
							<?php  $rating = intval($child->rating) ;?>
							<div class="rating <?php echo RatingClass($rating); ?>"></div>
							<div class="badges">
								<span class="label" style="background:<?php echo $child->color ?>"><?php echo $child->label ?></span>
							</div>
			...
			<div class="right">
				...
				<!-- Purchase Buttons -->
				<div class="purchase button" data-url=<?php echo $purchaseUrl  ?>>
				 <a href="#buy" >
				  <span class="icon"><i class="fa-fw fa fa-shopping-cart"></i></span>
				  <span class="text"><?php echo $Price ?> <i class="fa fa-usd"></i></span>				
				 </a>
			    </div>
			    <!-- !Purchase Buttons -->

		        <!-- Close Button -->
			    <div class="close" data-url=<?php echo $temblitesUrl?>>
			    ...
			    <div class=" cog" >
			      ...
			      <ul >
				   ...
				   <li><a href="#" target="_blank">Support </a><span><i class="fa fa-wrench"></i></span></li>
			     </ul>
			    </div>	
			    <!-- !Settings -->		    
		...
		<section class="section">
		   <iframe id="frame" src=<?php echo "$temblitesUrl" ?>></iframe>
        </section>
